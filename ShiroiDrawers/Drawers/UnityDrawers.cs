...
/* TODO: Find a way to fix this
    public class ExposedReferenceDrawer<T> : TypeDrawer<ExposedReference<T>> where T : Object {
        ...
        public override void Draw(Rect rect, GUIContent name, ExposedReference<T> value, Type valueType, FieldInfo fieldInfo, Setter setter) {
...
*/
    ...
    public class ObjectDrawer : TypeDrawer<Object> {
        public override void Draw(Rect rect, GUIContent name, Object value, Type valueType, FieldInfo fieldInfo, Setter setter) {
            setter(EditorGUI.ObjectField(rect, name, value, valueType, false));
        }
    }

    public class QuaternionDrawer : TypeDrawer<Quaternion> {
        public override void Draw(Rect rect, GUIContent name, Quaternion value, Type valueType, FieldInfo fieldInfo, Setter setter) {
            setter(Quaternion.Euler(EditorGUI.Vector3Field(rect, name, value.eulerAngles)));
        }
    }

    public class Vector2Drawer : TypeDrawer<Vector2> {
        public override void Draw(Rect rect, GUIContent name, Vector2 value, Type valueType, FieldInfo fieldInfo, Setter setter) {
            setter(EditorGUI.Vector2Field(rect, name, value));
        }
    }

    public class Vector3Drawer : TypeDrawer<Vector3> {
        public override void Draw(Rect rect, GUIContent name, Vector3 value, Type valueType, FieldInfo fieldInfo, Setter setter) {
            setter(EditorGUI.Vector3Field(rect, name, value));
        }
    }

    public class Vector4Drawer : TypeDrawer<Vector4> {
        public override void Draw(Rect rect, GUIContent name, Vector4 value, Type valueType, FieldInfo fieldInfo, Setter setter) {
            setter(EditorGUI.Vector4Field(rect, name, value));
        }
    }

    public class Vector2IntDrawer : TypeDrawer<Vector2Int> {
        public override void Draw(Rect rect, GUIContent name, Vector2Int value, Type valueType, FieldInfo fieldInfo, Setter setter) {
            setter(EditorGUI.Vector2IntField(rect, name, value));
        }
    }

    public class Vector3IntDrawer : TypeDrawer<Vector3Int> {
        public override void Draw(Rect rect, GUIContent name, Vector3Int value, Type valueType, FieldInfo fieldInfo, Setter setter) {
    ...
    public class BoundsDrawer : TypeDrawer<Bounds> {
        ...
        public override void Draw(Rect rect, GUIContent name, Bounds value, Type valueType, FieldInfo fieldInfo, Setter setter) {
    ...
    public class ColorDrawer : TypeDrawer<Color> {
        public override void Draw(Rect rect, GUIContent name, Color value, Type valueType, FieldInfo fieldInfo, Setter setter) {
            setter(EditorGUI.ColorField(rect, name, value));
        }
    }

    public class AnimationCurveDrawer : TypeDrawer<AnimationCurve> {
        public override void Draw(Rect rect, GUIContent name, AnimationCurve value, Type valueType, FieldInfo fieldInfo, Setter setter) {
    ...
    public class RectDrawer : TypeDrawer<Rect> {
        ...
        public override void Draw(Rect rect, GUIContent name, Rect value, Type valueType, FieldInfo fieldInfo, Setter setter) {
    ...
    public class RectIntDrawer : TypeDrawer<RectInt> {
        ...
        public override void Draw(Rect rect, GUIContent name, RectInt value, Type valueType, FieldInfo fieldInfo, Setter setter) {
    ...
    public class LayerMaskDrawer : TypeDrawer<LayerMask> {
        ...
        public override void Draw(Rect rect, GUIContent name, LayerMask value, Type valueType, FieldInfo fieldInfo, Setter setter) {
